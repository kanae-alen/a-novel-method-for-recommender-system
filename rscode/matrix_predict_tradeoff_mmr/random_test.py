...
# 创建折线图
plt.plot(indicators, method_A_values, marker='^', color='darkblue', label='Original Method')
plt.plot(indicators, method_B_values, marker='s', color='darkred', label='New Method')
...
# 设置子标题
# plt.suptitle('(a) $\\lambda_2$ = 0.50, $\\lambda_3$ = 0.50', y=0.04)
