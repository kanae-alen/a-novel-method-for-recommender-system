...
#——————————————————————————————————————————————————————————————————
df_train = pd.read_csv('D:/rscode/itembase_predict_tradeoff_mmr/train_data.txt', sep='\t', names=['user_id','item_id', 'rating'])
...
#——————————————————————————————————————————————————————————————————
df_test = pd.read_csv('D:/rscode/itembase_predict_tradeoff_mmr/test_data.txt', sep='\t', names=['user_id','item_id', 'rating'])
