...
from itembase_predict import topN1, K_ITEMS, THETA
from itembase_mmr import lambda_constant, topN2
from itembase_mmr import lambda_tradeoff
from itembase_mmr import topN3

from itembase_mmr import precision as precision_mmr
from itembase_mmr import average_diversity as average_diversity_mmr
from itembase_mmr import average_novelty as average_novelty_mmr
from itembase_mmr import coverage as coverage_mmr

from itembase_accuracy_diversity_tradeoff import precision as precision_acc_div_tradeoff
from itembase_accuracy_diversity_tradeoff import average_diversity as average_diversity_acc_div_tradeoff
from itembase_accuracy_diversity_tradeoff import average_novelty as average_novelty_acc_div_tradeoff
from itembase_accuracy_diversity_tradeoff import coverage as coverage_acc_div_tradeoff
# 测试用的R矩阵
#——————————————————————————————————————————————————————————————————
# R = np.array([
#     [1, 2, 1, np.nan, 3, 3],
